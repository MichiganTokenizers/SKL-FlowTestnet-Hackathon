                        ...
                        <div className="card shadow-sm border-0 text-start">
                            <div className="card-body" style={{ textAlign: 'left' }}>
                                <ul>
                                    ...
                                    <li>
                                        <strong>Contract Penalties:</strong> If a player is dropped or exits a contract early, a penalty of <b>25% of the contract value per remaining year</b> will be assessed. The penalty for each year is rounded up to the nearest dollar.
                                    </li>
                                    <li>
